  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Toko Elektronik Sani"),
        centerTitle: true,
        actions: const [
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            const SearchBar(),
            const DealSection(),
            SectionTitle(title: "Top Product", onViewAll: () {}),
            FreelancerList(),
            SectionTitle(title: "Best Product", onViewAll: () {}),
            const ServiceList(),
...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    },
    {
      ...
      "profession": "Elektronik",
      "rating": 4.9,
      "image": "assets/images/jam.jpeg"
    },
    {
      "name": "Tablet NoteBook",
      "profession": "Penulis",
      "rating": 4.9,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/jam.jpeg',
          name: 'SmartWatch',
          role: 'Elektronik',
          description: 'Produk SmartWatch adalah produk yang paling banyak dicari.',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'assets/images/tablet.jpeg',
          name: 'Tablet NoteBook',
          role: 'Elektronik',
          description: 'Notebook yang kami miliki dijamin kualitasnya terjamin.',
          rating: 4.9,
        ),
        ServiceCard(
          ...
          name: 'Computer',
          role: 'Elektronik',
          description: 'Produk ini merupakan produk dengan harga terjangkau.',
          rating: 4.9,
        ),
      ],
    );
...
class BestBooking2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        BestBookingCard(
          imageUrl: 'assets/images/bgtablet.jpg',
          profileUrl: 'assets/images/tablet.jpeg',
          name: 'Tablet NoteBook',
          role: 'Elektronik',
        ...
        BestBookingCard(
          imageUrl: 'assets/images/bgcomputer.jpg',
          profileUrl: 'assets/images/computer.jpg',
          name: 'Computer',
          role: 'Elektronik',
          description: 'Occaecati aut nam beatae quo non deserunt consequatur.',
          rating: 4.9,
